...
function stocks(symbol::AbstractString; start_date::Date=Date(2000), end_date::Date=today(), ssl_verification::Bool = true)::DataFrame
...
stocks(symbol::Symbol; start_date::Date=Date(2000), end_date::Date=today(), ssl_verification::Bool = true)::DataFrame =
  stocks(string(symbol); start_date=start_date, end_date=end_date, ssl_verification=ssl_verification)

function fred(series::AbstractString; start_date::Date=Date(2000), end_date::Date=today(), ssl_verification::Bool = true)::DataFrame
